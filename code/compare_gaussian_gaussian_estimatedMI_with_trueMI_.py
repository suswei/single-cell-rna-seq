...
for taskid in range(26):
    ...
    if not os.path.exists('result/compare_estimatedMI_with_trueMI/gaussian_gaussian'):
    ...
    final_dataframe.to_csv('result/compare_estimatedMI_with_trueMI/gaussian_gaussian/Taskid%s_Compare_mine_estimator_with_true_MI.csv'%(taskid), index=None, header=True)
