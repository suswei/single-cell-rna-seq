...
def main(taskid):
    ...
    hyperparameter_config = {
        ...
        'MineLoss_Scale': [200, 500, 800, 1000, 2000, 5000]
    }
    ...
    for i in range(len(hyperparameter_experiments)):
        ...
        vae_mine = VAE_MINE(gene_dataset.nb_genes, n_batch=gene_dataset.n_batches * use_batches, MineLoss_Scale=MineLoss_Scale)
        ...
        vae_mine_file_path = '%s/%s_%s_MineLossScale%s_sample%s_VaeMine.pk1'%(save_path, dataset_name, nuisance_variable, MineLoss_Scale, taskid)
        ...
        label = '%s_%s_sample%s_MineLossScale%s_VaeMine_trainset'%(dataset_name, nuisance_variable, taskid, MineLoss_Scale)
        ...
        label = '%s_%s_sample%s_MineLossScale%s_VaeMine_testset'%(dataset_name, nuisance_variable, taskid, MineLoss_Scale)
    ...
    vae_file_path = '%s/%s_%s_sample%s_Vae.pk1'%(save_path,dataset_name,nuisance_variable, taskid)
