...
from code.scvi import log_zinb_positive, log_nb_positive
...
class VAE(nn.Module):
    ...
    def __init__(self, n_input: int, n_batch: int = 0, n_labels: int = 0,
                 ...
                 log_variational: bool = True, reconstruction_loss: str = "zinb", adv_loss: bool=False):
        super().__init__()
    ...
    def forward(self, x, local_l_mean, local_l_var, batch_index=None, y=None):
        ...
        :param x: tensor of values with shape (batch_size, n_input) #here batch_size is minibatch size
        ...
        if self.adv_loss:
            return reconst_loss + kl_divergence_l, kl_divergence_z, qz_m, qz_v, z
        else:
